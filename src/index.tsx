...
import {} from "./server/data/tags";
import {} from "./server/data/bookmarkTags";
import {} from "./server/data/bookmarks";
import {
	homepageHandler,
	homepageSchema,
} from "./modules/homepage/formHandlers";
...
app.post("/", vValidator("form", homepageSchema), (context) => {
	const { user, session } = context.var;
	...
	homepageHandler(context, context.req.valid("form"));
